...
public class ExtensionsTest
{
    ...
    private static IQueryable<some> coll1 = new List<some>
        {
            new some(){a = 1, b = 2 },
            new some(){a = 2, b = 4 },
            new some(){a = 6, b = 32 },
    ...
    private static IQueryable<some> coll2 = new List<some>
        {
            new some(){a = 1, b = 2 },
            new some(){a = 2, b = 4 },
            new some(){a = 7, b = 8 },
    ...
    private static IQueryable<some> coll3 = new List<some>
        {
            new some(){a = 7, b = 8 },
            new some(){a = 6, b = 32 },
            new some(){a = 2, b = 4 },
    ...
    private static IQueryable<some> coll4 = new List<some>
        {
            new some(){a = 6, b = 32 },
            new some(){a = 7, b = 8 },
            new some(){a = 2, b = 4 },
