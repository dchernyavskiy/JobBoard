...
@NgModule({
  declarations: [AppComponent, HomeThreeComponent, JobDetailsComponent, FooterStyleTwoComponent, JobCardComponent, JobsnewComponent, FavouriteJobsComponent, EmployersComponent, EmployerCardComponent, DashboardComponent, PostAJobComponent, EmployersDetailsComponent, AdminLayoutComponent, EmployerComponent, EmployeeComponent  ],
  imports: [
    CommonModule,
    BrowserModule,
    AppRoutingModule,
